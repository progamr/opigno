<table id="learning-locker-stats-quizzes-table">
  <thead>
    <tr>
  ...
  <tbody>
    <?php foreach($quizzes as $quiz_id => $quiz) print theme('opigno_learning_locker_stats_quizzes_list_item', compact('quiz_id', 'quiz')); ?>
  </tbody>
</table>